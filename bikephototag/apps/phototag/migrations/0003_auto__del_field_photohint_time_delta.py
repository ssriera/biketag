...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PhotoHint.time_delta'
        db.delete_column(u'phototag_photohint', 'time_delta')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PhotoHint.time_delta'
        raise RuntimeError("Cannot reverse this migration. 'PhotoHint.time_delta' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PhotoHint.time_delta'
        db.add_column(u'phototag_photohint', 'time_delta',
