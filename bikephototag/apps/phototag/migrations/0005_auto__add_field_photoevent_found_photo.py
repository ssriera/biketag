...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhotoEvent.found_photo'
        db.add_column(u'phototag_photoevent', 'found_photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhotoEvent.found_photo'
        db.delete_column(u'phototag_photoevent', 'found_photo')
    ...
    models = {
        ...
        u'phototag.photoevent': {
            ...
            'found_photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
