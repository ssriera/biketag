...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhotoEvent.latitude'
        db.add_column(u'phototag_photoevent', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)

        # Adding field 'PhotoEvent.longitude'
        db.add_column(u'phototag_photoevent', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhotoEvent.latitude'
        db.delete_column(u'phototag_photoevent', 'latitude')

        # Deleting field 'PhotoEvent.longitude'
        db.delete_column(u'phototag_photoevent', 'longitude')
